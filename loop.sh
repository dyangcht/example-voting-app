...
do
    if (( $RANDOM % 3 )); then
        ...
        curl -s -X POST -d "voter_id=$(echo $RANDOM)&vote=a" http://vote-vote.apps.cluster-tpe-42f3.tpe-42f3.example.opentlc.com/ &
    else
        ...
        curl -s -X POST -d "voter_id=$(echo $RANDOM)&vote=b" http://vote-vote.apps.cluster-tpe-42f3.tpe-42f3.example.opentlc.com/ &
    fi
  sleep 1
  # echo $i
  # echo $RANDOM
